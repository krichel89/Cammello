...
TRANSLATIONS = {
    ...
    'Composer died:': {
        'de': 'Todesjahr des Komponisten:',
        'es': 'Fallecimiento del compositor:',
        'fr': 'Décès du compositeur :',
        'it': 'Morte del compositore:',
    },
    'Year of composition:': {
        'de': 'Kompositionsjahr:',
        'es': 'Año de composición:',
        'fr': 'Année de composition :',
        'it': 'Anno di composizione:',
    },
    'Recorded by:': {
        'de': 'Aufgenommen von:',
        'es': 'Grabado por:',
    ...
    'Recording technique:': {
        'de': 'Aufnahmetechnik:',
        'es': 'Técnica de grabación:',
        'fr': 'Technique d’enregistrement :',
        'it': 'Tecnica di registrazione:',
    },
    'Source template:': {
        'de': 'Quellenvorlage:',
        'es': 'Plantilla de fuente:',
        'fr': 'Modèle de source :',
        'it': 'Template della fonte:',
    },
    'Licence of the composition:': {
        'de': 'Lizenz der Komposition:',
        'es': 'Licencia de la composición:',
        'fr': 'Licence de la composition :',
        'it': 'Licenza della composizione:',
    },
    'Licence of the recording:': {
        'de': 'Lizenz der Aufnahme:',
        'es': 'Licencia de la grabación:',
        'fr': 'Licence de l’enregistrement :',
        'it': 'Licenza della registrazione:',
    },
    'Instrument:': {
        'de': 'Instrument:',
        'es': 'Instrumento:',
    ...
    'Work (category name):': {
        'de': 'Werk (Kategoriename):',
        'es': 'Obra (nombre de categoría):',
        'fr': 'Œuvre (nom de catégorie) :',
        'it': 'Opera (nome della categoria):',
    },
    'Country:': {
        'de': 'Land:',
        'es': 'País:',
    ...
    'fields to SHOW that are off by default (marked below)': {
        'de': 'standardmäßig ausgeschaltete Felder EINSCHALTEN (unten gekennzeichnet)',
        'es': 'campos desactivados por defecto que se MUESTRAN (marcados abajo)',
        'fr': 'champs désactivés par défaut à AFFICHER (marqués ci-dessous)',
        'it': 'campi disattivati per impostazione predefinita da MOSTRARE (segnati sotto)',
    },
    'off by default': {
        'de': 'standardmäßig aus',
        'es': 'desactivado por defecto',
        'fr': 'désactivé par défaut',
        'it': 'disattivato per impostazione predefinita',
    },
    'For recordings by other people: who composed it, who recorded it, and\nunder which two licences it stands.': {
        'de': 'Für Aufnahmen anderer: wer komponiert hat, wer aufgenommen hat und\nunter welchen zwei Lizenzen die Datei steht.',
        'es': 'Para grabaciones de otras personas: quién la compuso, quién la grabó y\nbajo qué dos licencias está.',
        'fr': 'Pour les enregistrements d’autres personnes : qui a composé, qui a\nenregistré et sous quelles deux licences le fichier se trouve.',
        'it': 'Per registrazioni di altri: chi ha composto, chi ha registrato e\nsotto quali due licenze si trova il file.',
    },
    'The composer as wikitext, normally an interwiki link with a leading colon:\n\n  [[:en:Felix Mendelssohn|Felix Mendelssohn Bartoldy]]\n\nGoes into the author line as the "composition" role. The LINK TARGET is\nalso what the generated categories are built from.': {
        'de': 'Der Komponist als Wikitext, normalerweise ein Interwiki-Link mit führendem Doppelpunkt:\n\n  [[:en:Felix Mendelssohn|Felix Mendelssohn Bartoldy]]\n\nKommt als Rolle „composition“ in die Autorzeile. Aus dem LINKZIEL werden\nauch die erzeugten Kategorien gebaut.',
        'es': 'El compositor como wikitexto, normalmente un enlace interwiki con dos puntos iniciales:\n\n  [[:en:Felix Mendelssohn|Felix Mendelssohn Bartoldy]]\n\nVa a la línea de autor como rol «composition». Del DESTINO DEL ENLACE se\nconstruyen también las categorías generadas.',
        'fr': 'Le compositeur en wikitexte, normalement un lien interwiki précédé de deux-points :\n\n  [[:en:Felix Mendelssohn|Felix Mendelssohn Bartoldy]]\n\nEntre dans la ligne d’auteur comme rôle « composition ». La CIBLE DU LIEN\nsert aussi à construire les catégories générées.',
        'it': 'Il compositore come wikitesto, di norma un collegamento interwiki con due punti iniziali:\n\n  [[:en:Felix Mendelssohn|Felix Mendelssohn Bartoldy]]\n\nEntra nella riga dell’autore come ruolo «composition». Dalla DESTINAZIONE\ndel collegamento si costruiscono anche le categorie generate.',
    },
    'Who made the recording - the second role of the author line, and the\nperson the "recorded by" categories name. Not the uploader.': {
        'de': 'Wer die Aufnahme gemacht hat — die zweite Rolle der Autorzeile und die\nPerson, die in den „recorded by“-Kategorien steht. Nicht der Hochladende.',
        'es': 'Quién hizo la grabación: el segundo rol de la línea de autor y la persona\nque nombran las categorías «recorded by». No quien sube el archivo.',
        'fr': 'Qui a réalisé l’enregistrement — le second rôle de la ligne d’auteur et la\npersonne nommée par les catégories « recorded by ». Pas l’importateur.',
        'it': 'Chi ha realizzato la registrazione: il secondo ruolo della riga dell’autore\ne la persona nominata dalle categorie «recorded by». Non chi carica.',
    },
    'The licence of the WORK, e.g. {{PD-old-auto-expired}}. If "Composer died"\nis filled and the template says nothing about a death year, |deathyear=\nis added automatically.': {
        'de': 'Die Lizenz des WERKS, z. B. {{PD-old-auto-expired}}. Ist „Todesjahr des\nKomponisten“ gefüllt und die Vorlage sagt nichts über ein Todesjahr, wird\n|deathyear= automatisch ergänzt.',
        'es': 'La licencia de la OBRA, p. ej. {{PD-old-auto-expired}}. Si «Fallecimiento\ndel compositor» está relleno y la plantilla no menciona un año de muerte,\nse añade |deathyear= automáticamente.',
        'fr': 'La licence de l’ŒUVRE, p. ex. {{PD-old-auto-expired}}. Si « Décès du\ncompositeur » est rempli et que le modèle ne mentionne pas d’année de décès,\n|deathyear= est ajouté automatiquement.',
        'it': 'La licenza dell’OPERA, ad es. {{PD-old-auto-expired}}. Se «Morte del\ncompositore» è compilato e il template non indica un anno di morte,\n|deathyear= viene aggiunto automaticamente.',
    },
    'The licence of the RECORDING, which is a separate right from the work.\nOften a permission template of the person who recorded it.': {
        'de': 'Die Lizenz der AUFNAHME, ein vom Werk getrenntes Recht. Oft eine\nFreigabevorlage der Person, die aufgenommen hat.',
        'es': 'La licencia de la GRABACIÓN, un derecho distinto del de la obra. A menudo\nuna plantilla de permiso de quien grabó.',
        'fr': 'La licence de l’ENREGISTREMENT, un droit distinct de celui de l’œuvre.\nSouvent un modèle d’autorisation de la personne qui a enregistré.',
        'it': 'La licenza della REGISTRAZIONE, un diritto distinto da quello dell’opera.\nSpesso un template di autorizzazione di chi ha registrato.',
    },
    'A category name for the work itself, e.g. Six organ sonatas (Mendelssohn).\nUsed as written; like every generated category it is dropped if Commons\ndoes not have it.': {
        'de': 'Ein Kategoriename für das Werk selbst, z. B. Six organ sonatas (Mendelssohn).\nWird wörtlich übernommen; wie jede erzeugte Kategorie entfällt sie, wenn\nCommons sie nicht hat.',
        'es': 'Un nombre de categoría para la obra misma, p. ej. Six organ sonatas\n(Mendelssohn). Se usa tal cual; como toda categoría generada se descarta si\nCommons no la tiene.',
        'fr': 'Un nom de catégorie pour l’œuvre elle-même, p. ex. Six organ sonatas\n(Mendelssohn). Repris tel quel ; comme toute catégorie générée, il est\nabandonné si Commons ne l’a pas.',
        'it': 'Un nome di categoria per l’opera stessa, ad es. Six organ sonatas\n(Mendelssohn). Usato così com’è; come ogni categoria generata viene\nscartato se Commons non ce l’ha.',
    },
    'New workflows': {
        'de': 'Neue Workflows',
        'es': 'Nuevos flujos de trabajo',
        'fr': 'Nouveaux workflows',
        'it': 'Nuovi flussi di lavoro',
    },
    'This version brings workflows your workflow file does not have yet: {names}.': {
        'de': 'Diese Version bringt Workflows mit, die in deiner Workflow-Datei noch fehlen: {names}.',
        'es': 'Esta versión trae flujos de trabajo que su archivo aún no tiene: {names}.',
        'fr': 'Cette version apporte des workflows que votre fichier ne contient pas encore : {names}.',
        'it': 'Questa versione porta flussi di lavoro che il tuo file non ha ancora: {names}.',
    },
    'Add them to the file? Nothing already in it is changed - the entries are appended, and a copy is kept as workflows.toml.bak.': {
        'de': 'In die Datei aufnehmen? Vorhandenes wird nicht verändert — die Einträge werden angehängt, und eine Kopie bleibt als workflows.toml.bak liegen.',
        'es': '¿Añadirlos al archivo? No se cambia nada de lo existente: las entradas se añaden al final y queda una copia como workflows.toml.bak.',
        'fr': 'Les ajouter au fichier ? Rien de ce qui s’y trouve n’est modifié : les entrées sont ajoutées à la fin et une copie est conservée sous workflows.toml.bak.',
        'it': 'Aggiungerli al file? Nulla di ciò che c’è già viene modificato: le voci vengono accodate e una copia resta come workflows.toml.bak.',
    },
    'Add': {
        'de': 'Aufnehmen',
        'es': 'Añadir',
    ...
    'The part of a recording that holds for the WHOLE delivery: who recorded\nit, on what, from which source and under which licence. The piece itself\n- composer, work, year - belongs to the selection, in the description\neditor on the right.': {
        'de': 'Der Teil einer Aufnahme, der für die GANZE Lieferung gilt: wer aufgenommen\nhat, womit, aus welcher Quelle und unter welcher Lizenz. Das Stück selbst\n— Komponist, Werk, Jahr — gehört zur Auswahl, in den Beschreibungseditor\nrechts.',
        'es': 'La parte de una grabación que vale para TODA la entrega: quién grabó,\ncon qué, de qué fuente y bajo qué licencia. La pieza en sí —compositor,\nobra, año— pertenece a la selección, en el editor de descripción de la\nderecha.',
        'fr': 'La partie d’un enregistrement qui vaut pour TOUTE la livraison : qui a\nenregistré, avec quoi, depuis quelle source et sous quelle licence.\nL’œuvre elle-même — compositeur, œuvre, année — relève de la sélection,\ndans l’éditeur de description à droite.',
        'it': 'La parte di una registrazione valida per TUTTA la consegna: chi ha\nregistrato, con che cosa, da quale fonte e sotto quale licenza. Il brano\nstesso — compositore, opera, anno — appartiene alla selezione, nell’editor\ndi descrizione a destra.',
    },
    'Move to…': {
        'de': 'Verschieben nach…',
        'es': 'Mover a…',
    ...
    'Moves the selected images into a local folder. Always the WHOLE group -\nRAW, JPEG and .xmp sidecar together, whatever the pair selector says,\nbecause half a pair left behind is not worth anything. Nothing in the\ntarget folder is ever overwritten.': {
        'de': 'Verschiebt die ausgewählten Bilder in einen lokalen Ordner. Immer die GANZE\nGruppe — RAW, JPEG und .xmp-Sidecar zusammen, unabhängig vom Paarselektor,\ndenn eine zurückgelassene Hälfte ist nichts wert. Im Zielordner wird nie\netwas überschrieben.',
        'es': 'Mueve las imágenes seleccionadas a una carpeta local. Siempre el grupo\nCOMPLETO: RAW, JPEG y el sidecar .xmp juntos, sea cual sea el selector de\npares, porque media pareja abandonada no vale nada. Nunca se sobrescribe\nnada en la carpeta de destino.',
        'fr': 'Déplace les images sélectionnées vers un dossier local. Toujours le groupe\nENTIER — RAW, JPEG et le fichier .xmp ensemble, quel que soit le sélecteur\nde paires, car une moitié laissée derrière ne vaut rien. Rien n’est jamais\nécrasé dans le dossier cible.',
        'it': 'Sposta le immagini selezionate in una cartella locale. Sempre l’INTERO\ngruppo: RAW, JPEG e il sidecar .xmp insieme, qualunque cosa dica il\nselettore di coppie, perché mezza coppia lasciata indietro non vale nulla.\nNella cartella di destinazione non viene mai sovrascritto nulla.',
    },
    'Move selection to folder': {
        'de': 'Auswahl in Ordner verschieben',
        'es': 'Mover la selección a una carpeta',
        'fr': 'Déplacer la sélection vers un dossier',
        'it': 'Sposta la selezione in una cartella',
    },
    'Move to folder': {
        'de': 'In Ordner verschieben',
        'es': 'Mover a la carpeta',
        'fr': 'Déplacer vers le dossier',
        'it': 'Sposta nella cartella',
    },
    'Move': {
        'de': 'Verschieben',
        'es': 'Mover',
    ...
    'That is the folder that is open - there is nothing to move.': {
        'de': 'Das ist der geöffnete Ordner — da gibt es nichts zu verschieben.',
        'es': 'Esa es la carpeta abierta: no hay nada que mover.',
        'fr': 'C’est le dossier ouvert — il n’y a rien à déplacer.',
        'it': 'Questa è la cartella aperta: non c’è nulla da spostare.',
    },
    'These files are already in the target folder, so nothing was moved:\n\n{names}': {
        'de': 'Diese Dateien liegen schon im Zielordner, deshalb wurde nichts verschoben:\n\n{names}',
        'es': 'Estos archivos ya están en la carpeta de destino, así que no se movió nada:\n\n{names}',
        'fr': 'Ces fichiers sont déjà dans le dossier cible, rien n’a donc été déplacé :\n\n{names}',
        'it': 'Questi file sono già nella cartella di destinazione, quindi non è stato spostato nulla:\n\n{names}',
    },
    'Done: {ok}/{total} file(s) moved': {
        'de': 'Fertig: {ok}/{total} Datei(en) verschoben',
        'es': 'Listo: {ok}/{total} archivo(s) movido(s)',
        'fr': 'Terminé : {ok}/{total} fichier(s) déplacé(s)',
        'it': 'Fatto: {ok}/{total} file spostati',
    },
    'Cancelled: {ok}/{total} file(s) moved, {n} not started.': {
        'de': 'Abgebrochen: {ok}/{total} Datei(en) verschoben, {n} nicht begonnen.',
        'es': 'Cancelado: {ok}/{total} archivo(s) movido(s), {n} sin empezar.',
        'fr': 'Annulé : {ok}/{total} fichier(s) déplacé(s), {n} non commencés.',
        'it': 'Annullato: {ok}/{total} file spostati, {n} non avviati.',
    },
    'Author:': {
        'de': 'Autor:',
        'es': 'Autor:',
    ...
    'Copy pictures straight off a connected camera into a folder and open that folder.\nMeant as the backup when no card reader is at hand - a reader is considerably faster.': {
        'de': 'Kopiert Bilder direkt von einer angeschlossenen Kamera in einen Ordner und\nöffnet diesen Ordner. Gedacht als Notweg, wenn kein Kartenleser da ist — ein\nLeser ist deutlich schneller.',
        'es': 'Copia las fotos directamente de una cámara conectada a una carpeta y abre esa\ncarpeta. Pensado como recurso cuando no hay lector de tarjetas a mano: un\nlector es bastante más rápido.',
        'fr': 'Copie les images directement depuis un appareil connecté vers un dossier et\nouvre ce dossier. Prévu comme solution de secours en l’absence de lecteur de\ncartes — un lecteur est nettement plus rapide.',
        'it': 'Copia le immagini direttamente da una fotocamera collegata in una cartella e\napre quella cartella. Pensato come ripiego quando manca un lettore di schede:\nun lettore è decisamente più veloce.',
    },
    'Import from camera': {
        'de': 'Von Kamera importieren',
        'es': 'Importar desde la cámara',
        'fr': 'Importer depuis l’appareil',
        'it': 'Importa dalla fotocamera',
    },
    'Import from camera into folder': {
        'de': 'Von Kamera in diesen Ordner importieren',
        'es': 'Importar de la cámara a esta carpeta',
        'fr': 'Importer depuis l’appareil vers ce dossier',
        'it': 'Importa dalla fotocamera in questa cartella',
    },
    'Which camera?': {
        'de': 'Welche Kamera?',
        'es': '¿Qué cámara?',
    ...
    'Reading the card: {n} file(s) so far…': {
        'de': 'Karte wird gelesen: bisher {n} Datei(en)…',
        'es': 'Leyendo la tarjeta: {n} archivo(s) hasta ahora…',
        'fr': 'Lecture de la carte : {n} fichier(s) jusqu’ici…',
        'it': 'Lettura della scheda: finora {n} file…',
    },
    'No camera answered. Switch it on, connect the USB cable, and close any other program that may be holding the camera.': {
        'de': 'Keine Kamera hat geantwortet. Einschalten, USB-Kabel anschließen und jedes andere Programm schließen, das die Kamera belegen könnte.',
        'es': 'Ninguna cámara respondió. Enciéndela, conecta el cable USB y cierra cualquier otro programa que pueda estar ocupando la cámara.',
        'fr': 'Aucun appareil n’a répondu. Allumez-le, branchez le câble USB et fermez tout autre programme susceptible de monopoliser l’appareil.',
        'it': 'Nessuna fotocamera ha risposto. Accendila, collega il cavo USB e chiudi ogni altro programma che potrebbe tenerla occupata.',
    },
    'Importing straight from a camera is not available on Windows yet. Use a card reader for now.': {
        'de': 'Der Import direkt von der Kamera gibt es unter Windows noch nicht. Bis dahin bitte einen Kartenleser verwenden.',
        'es': 'La importación directa desde la cámara aún no está disponible en Windows. Por ahora usa un lector de tarjetas.',
        'fr': 'L’import direct depuis l’appareil n’existe pas encore sous Windows. Utilisez un lecteur de cartes en attendant.',
        'it': 'L’importazione diretta dalla fotocamera non è ancora disponibile su Windows. Per ora usa un lettore di schede.',
    },
    'The gphoto2 module is missing, so no camera can be reached. Install it with: pip install gphoto2': {
        'de': 'Das Modul gphoto2 fehlt, deshalb ist keine Kamera erreichbar. Installation mit: pip install gphoto2',
        'es': 'Falta el módulo gphoto2, así que no se puede acceder a ninguna cámara. Instálalo con: pip install gphoto2',
    ...
    '(already in the folder)': {
        'de': '(schon im Ordner)',
        'es': '(ya está en la carpeta)',
        'fr': '(déjà dans le dossier)',
        'it': '(già nella cartella)',
    },
    'All': {
        'de': 'Alle',
        'es': 'Todo',
    ...
    'No time on the card': {
        'de': 'Keine Zeit auf der Karte',
        'es': 'Sin hora en la tarjeta',
        'fr': 'Aucune heure sur la carte',
        'it': 'Nessun orario sulla scheda',
    },
    'None': {
        'de': 'Keine',
        'es': 'Ninguno',
    ...
    'Reading the card…': {
        ...
        'es': 'Leyendo la tarjeta…',
        'fr': 'Lecture de la carte…',
        'it': 'Lettura della scheda…',
    },
    'The card holds no images.': {
        'de': 'Auf der Karte sind keine Bilder.',
        'es': 'La tarjeta no contiene imágenes.',
        'fr': 'La carte ne contient aucune image.',
        'it': 'La scheda non contiene immagini.',
    },
    'no time': {
        'de': 'keine Zeit',
        'es': 'sin hora',
    ...
    '{n} of {total} selected, {size}': {
        'de': '{n} von {total} ausgewählt, {size}',
        'es': '{n} de {total} seleccionados, {size}',
        'fr': '{n} sur {total} sélectionnés, {size}',
        'it': '{n} di {total} selezionati, {size}',
    },
    'Clear filter': {
        'de': 'Filter aufheben',
        'es': 'Quitar filtro',
    ...
    'Show every image again: no star limit, no colour limit, rejects visible. Opening a folder or a card does this by itself.': {
        'de': 'Wieder alle Bilder zeigen: keine Sternegrenze, keine Farbgrenze, Ausschuss sichtbar. Beim Öffnen eines Ordners oder einer Karte geschieht das von selbst.',
        'es': 'Volver a mostrar todas las imágenes: sin límite de estrellas, sin límite de color, los descartes visibles. Al abrir una carpeta o una tarjeta ocurre automáticamente.',
        'fr': 'Afficher de nouveau toutes les images : aucune limite d’étoiles, aucune limite de couleur, les rebuts visibles. L’ouverture d’un dossier ou d’une carte le fait d’elle-même.',
        'it': 'Mostra di nuovo tutte le immagini: nessun limite di stelle, nessun limite di colore, gli scarti visibili. All’apertura di una cartella o di una scheda avviene da sé.',
    },
    'A shooting day starts at 4 in the morning, so an evening that runs\npast midnight stays one day. The time is the file time, as for the order.': {
        'de': 'Ein Aufnahmetag beginnt um 4 Uhr morgens, damit ein Abend, der über\nMitternacht läuft, ein Tag bleibt. Die Zeit ist die Dateizeit, wie bei der Reihenfolge.',
        'es': 'Un día de trabajo empieza a las 4 de la mañana, para que una velada que pasa\nde la medianoche siga siendo un solo día. La hora es la del archivo, como en el orden.',
        'fr': 'Une journée de prise de vue commence à 4 heures du matin, afin qu’une soirée qui\ndépasse minuit reste un seul jour. L’heure est celle du fichier, comme pour le tri.',
        'it': 'Una giornata di scatto inizia alle 4 del mattino, così una serata che supera\nla mezzanotte resta un solo giorno. L’orario è quello del file, come per l’ordine.',
    },
    'no time ({n})': {
        'de': 'ohne Zeit ({n})',
        'es': 'sin hora ({n})',
    ...
    'Close the card and unmount it. Ratings still waiting to be written\nare written first; the card is only reported as safe when it is really gone.': {
        'de': 'Die Karte schließen und aushängen. Noch nicht geschriebene Bewertungen\nwerden vorher geschrieben; sicher gemeldet wird die Karte erst, wenn sie wirklich weg ist.',
        'es': 'Cerrar la tarjeta y desmontarla. Las valoraciones pendientes se escriben\nantes; la tarjeta solo se da por segura cuando realmente ha desaparecido.',
        'fr': 'Fermer la carte et la démonter. Les notes encore en attente sont écrites\nd’abord ; la carte n’est déclarée sûre que lorsqu’elle a réellement disparu.',
        'it': 'Chiudere la scheda e smontarla. Le valutazioni ancora in attesa vengono\nscritte prima; la scheda è dichiarata sicura solo quando è davvero sparita.',
    },
    'Eject card': {
        'de': 'Karte auswerfen',
        'es': 'Expulsar tarjeta',
    ...
    'Ratings could not be written to the card, so it was not ejected. The log has the details.': {
        'de': 'Bewertungen konnten nicht auf die Karte geschrieben werden, deshalb wurde sie nicht ausgeworfen. Einzelheiten stehen im Protokoll.',
        'es': 'No se pudieron escribir las valoraciones en la tarjeta, por eso no se expulsó. Los detalles están en el registro.',
        'fr': 'Les notes n’ont pas pu être écrites sur la carte, elle n’a donc pas été éjectée. Les détails figurent dans le journal.',
        'it': 'Non è stato possibile scrivere le valutazioni sulla scheda, quindi non è stata espulsa. I dettagli sono nel registro.',
    },
    'The system did not report an error, but the card is still mounted. Something else may be using it.': {
        'de': 'Das System hat keinen Fehler gemeldet, die Karte ist aber noch eingehängt. Möglicherweise benutzt sie ein anderes Programm.',
        'es': 'El sistema no informó de ningún error, pero la tarjeta sigue montada. Puede que otro programa la esté usando.',
        'fr': 'Le système n’a signalé aucune erreur, mais la carte est toujours montée. Un autre programme l’utilise peut-être.',
        'it': 'Il sistema non ha segnalato errori, ma la scheda è ancora montata. Forse la sta usando un altro programma.',
    },
    '{name} can be removed.': {
        'de': '{name} kann entnommen werden.',
        'es': '{name} se puede retirar.',
        'fr': '{name} peut être retirée.',
        'it': '{name} può essere rimossa.',
    },
    '{name} could not be ejected.': {
        'de': '{name} konnte nicht ausgeworfen werden.',
        'es': 'No se pudo expulsar {name}.',
        'fr': '{name} n’a pas pu être éjectée.',
        'it': 'Non è stato possibile espellere {name}.',
    },
    'Another program is holding the camera. Quit Lightroom, Photos, Image Capture and EOS Utility, then run "killall ptpcamerad" in Terminal - macOS restarts that helper by itself and it grabs the camera on sight. Cammello retries once before showing this.': {
        'de': 'Ein anderes Programm hält die Kamera. Beende Lightroom, Fotos, Digitale Bilder und EOS Utility und führe im Terminal „killall ptpcamerad" aus — macOS startet diesen Dienst von selbst neu, und er greift bei jedem Anstecken zu. Cammello hat es bereits ein zweites Mal versucht.',
        'es': 'Otro programa está usando la cámara. Cierra Lightroom, Fotos, Captura de Imagen y EOS Utility y ejecuta «killall ptpcamerad» en el Terminal: macOS reinicia ese servicio por sí solo y toma la cámara en cuanto la ve. Cammello ya lo ha intentado una segunda vez.',
        'fr': 'Un autre programme occupe l’appareil photo. Quittez Lightroom, Photos, Transfert d’images et EOS Utility, puis lancez « killall ptpcamerad » dans le Terminal : macOS relance ce service tout seul et il s’empare de l’appareil dès qu’il le voit. Cammello a déjà réessayé une fois.',
        'it': 'Un altro programma sta occupando la fotocamera. Chiudi Lightroom, Foto, Acquisizione Immagine ed EOS Utility, poi esegui «killall ptpcamerad» nel Terminale: macOS riavvia da sé quel servizio, che prende la fotocamera appena la vede. Cammello ha già riprovato una seconda volta.',
    },
    'Previews: {done} of {total}. Scrolling fetches what you look at first.': {
        'de': 'Vorschau: {done} von {total}. Beim Blättern wird zuerst geholt, was du ansiehst.',
        'es': 'Vistas previas: {done} de {total}. Al desplazarte se carga primero lo que miras.',
        'fr': 'Aperçus : {done} sur {total}. En faisant défiler, ce que vous regardez est chargé en premier.',
        'it': 'Anteprime: {done} di {total}. Scorrendo viene caricato prima ciò che guardi.',
    },
    'The camera is still busy with the previews. Try again in a moment.': {
        'de': 'Die Kamera ist noch mit den Vorschaubildern beschäftigt. Bitte gleich nochmal versuchen.',
        'es': 'La cámara sigue ocupada con las vistas previas. Inténtalo de nuevo en un momento.',
        'fr': 'L’appareil photo est encore occupé par les aperçus. Réessayez dans un instant.',
        'it': 'La fotocamera è ancora occupata con le anteprime. Riprova tra un momento.',
    },
    'A filter is active - click to show it': {
        'de': 'Ein Filter ist aktiv – klicken, um ihn einzublenden',
        'es': 'Hay un filtro activo: haz clic para mostrarlo',
        'fr': 'Un filtre est actif – cliquez pour l’afficher',
        'it': 'Un filtro è attivo – clicca per mostrarlo',
    },
    'Clear filter - show every image again: no star limit, no colour limit,\nrejects visible. Opening a folder or a card does this by itself.': {
        'de': 'Filter aufheben – wieder alle Bilder zeigen: keine Sternegrenze, keine Farbgrenze,\nAusschuss sichtbar. Beim Öffnen eines Ordners oder einer Karte geschieht das von selbst.',
        'es': 'Quitar filtro: volver a mostrar todas las imágenes, sin límite de estrellas ni de color,\ncon los descartes visibles. Al abrir una carpeta o una tarjeta ocurre automáticamente.',
        'fr': 'Annuler le filtre – afficher de nouveau toutes les images : aucune limite d’étoiles ni de couleur,\nles rebuts visibles. L’ouverture d’un dossier ou d’une carte le fait d’elle-même.',
        'it': 'Azzera filtro – mostra di nuovo tutte le immagini: nessun limite di stelle o di colore,\ngli scarti visibili. All’apertura di una cartella o di una scheda avviene da sé.',
    },
    'Eject card - close the card and unmount it. Ratings still waiting to be written\nare written first; the card is only reported as safe when it is really gone.': {
        'de': 'Karte auswerfen – die Karte schließen und aushängen. Noch nicht geschriebene Bewertungen\nwerden vorher geschrieben; sicher gemeldet wird die Karte erst, wenn sie wirklich weg ist.',
        'es': 'Expulsar tarjeta: cerrar la tarjeta y desmontarla. Las valoraciones pendientes se escriben\nantes; la tarjeta solo se da por segura cuando realmente ha desaparecido.',
        'fr': 'Éjecter la carte – fermer la carte et la démonter. Les notes encore en attente sont écrites\nd’abord ; la carte n’est déclarée sûre que lorsqu’elle a réellement disparu.',
        'it': 'Espelli scheda – chiudere la scheda e smontarla. Le valutazioni ancora in attesa vengono\nscritte prima; la scheda è dichiarata sicura solo quando è davvero sparita.',
    },
    'From camera… - copy pictures straight off a connected camera into a folder and\nopen that folder. Meant as the backup when no card reader is at hand -\na reader is considerably faster.': {
        'de': 'Von Kamera… – Bilder direkt von einer angeschlossenen Kamera in einen Ordner kopieren\nund diesen öffnen. Gedacht als Notweg ohne Kartenleser –\nein Leser ist erheblich schneller.',
        'es': 'Desde la cámara…: copiar las fotos directamente de una cámara conectada a una carpeta\ny abrirla. Pensado como recurso cuando no hay lector de tarjetas;\nun lector es bastante más rápido.',
        'fr': 'Depuis l’appareil photo… – copier les images directement d’un appareil connecté dans un dossier\net ouvrir celui-ci. Prévu comme solution de secours sans lecteur de cartes ;\nun lecteur est nettement plus rapide.',
        'it': 'Dalla fotocamera… – copiare le immagini direttamente da una fotocamera collegata in una cartella\ne aprirla. Pensato come ripiego senza lettore di schede:\nun lettore è decisamente più veloce.',
    },
    'Hide the filter': {
        'de': 'Filter ausblenden',
        'es': 'Ocultar el filtro',
        'fr': 'Masquer le filtre',
        'it': 'Nascondi il filtro',
    },
    'Show the filter': {
        'de': 'Filter einblenden',
        'es': 'Mostrar el filtro',
        'fr': 'Afficher le filtre',
        'it': 'Mostra il filtro',
    },
    '(no caption - unchanged)': {
        'de': '(keine Bildunterschrift – unverändert)',
        'es': '(sin pie de foto: sin cambios)',
        'fr': '(pas de légende – inchangé)',
        'it': '(nessuna didascalia – invariato)',
    },
    'Build target filenames from the captions: person, event and the number from the camera.': {
        'de': 'Zieldateinamen aus den Bildunterschriften bauen: Person, Veranstaltung und die Nummer aus der Kamera.',
        'es': 'Construir los nombres de archivo a partir de los pies de foto: persona, evento y el número de la cámara.',
        'fr': 'Construire les noms de fichiers à partir des légendes : personne, événement et le numéro de l’appareil.',
        'it': 'Costruire i nomi dei file dalle didascalie: persona, evento e il numero della fotocamera.',
    },
    'Names from &descriptions…': {
        'de': 'Namen aus &Beschreibungen…',
        'es': 'Nombres desde las &descripciones…',
        'fr': 'Noms depuis les &descriptions…',
        'it': 'Nomi dalle &descrizioni…',
    },
    'Names from descriptions': {
        'de': 'Namen aus Beschreibungen',
        'es': 'Nombres desde las descripciones',
    ...
    'Names from descriptions - build the target filenames from the captions:\nperson, event and the number from the camera. Shows what it would do first.': {
        'de': 'Namen aus Beschreibungen – die Zieldateinamen aus den Bildunterschriften bauen:\nPerson, Veranstaltung und die Nummer aus der Kamera. Zeigt vorher, was es täte.',
        'es': 'Nombres desde las descripciones: construir los nombres de archivo a partir de los pies de foto:\npersona, evento y el número de la cámara. Primero muestra lo que haría.',
        'fr': 'Noms depuis les descriptions – construire les noms de fichiers à partir des légendes :\npersonne, événement et le numéro de l’appareil. Affiche d’abord ce qu’il ferait.',
        'it': 'Nomi dalle descrizioni – costruire i nomi dei file dalle didascalie:\npersona, evento e il numero della fotocamera. Mostra prima cosa farebbe.',
    },
    'New': {
        'de': 'Neu',
        'es': 'Nuevo',
    ...
    'Person - original file number': {
        'de': 'Person – Originalnummer',
        'es': 'Persona: número original',
        'fr': 'Personne – numéro d’origine',
        'it': 'Persona – numero originale',
    },
    'Person at event - original file number': {
        'de': 'Person bei Veranstaltung – Originalnummer',
        'es': 'Persona en evento: número original',
    ...
    '{n} file(s) have no caption and keep the name they have.': {
        'de': '{n} Datei(en) haben keine Bildunterschrift und behalten ihren Namen.',
        'es': '{n} archivo(s) no tienen pie de foto y conservan su nombre.',
        'fr': '{n} fichier(s) n’ont pas de légende et gardent leur nom.',
        'it': '{n} file non hanno didascalia e mantengono il loro nome.',
    },
    '{n} file(s) have no caption to build a name from and were left unchanged.': {
        'de': '{n} Datei(en) haben keine Bildunterschrift, aus der sich ein Name bauen ließe, und blieben unverändert.',
        'es': '{n} archivo(s) no tienen un pie de foto del que construir un nombre y quedaron sin cambios.',
        'fr': '{n} fichier(s) n’ont pas de légende permettant de construire un nom et sont restés inchangés.',
        'it': '{n} file non hanno una didascalia da cui costruire un nome e sono rimasti invariati.',
    },
    '{n} of {total} file(s) get a name from their caption.': {
        'de': '{n} von {total} Datei(en) bekommen einen Namen aus ihrer Bildunterschrift.',
        'es': '{n} de {total} archivo(s) reciben un nombre de su pie de foto.',
        'fr': '{n} fichier(s) sur {total} reçoivent un nom issu de leur légende.',
        'it': '{n} file su {total} ricevono un nome dalla loro didascalia.',
    },
    'Export…': {
        'de': 'Export…',
        'es': 'Exportar…',
    ...
    'Moves or copies the selected images into a local folder. The dialog asks\nwhich of the two, and whether to take the whole group (RAW, JPEG and\n.xmp sidecar) or RAW + sidecar only. Nothing in the target folder is\never overwritten.': {
        'de': 'Verschiebt oder kopiert die ausgewählten Bilder in einen lokalen Ordner.\nDer Dialog fragt, welches von beidem — und ob die ganze Gruppe (RAW, JPEG\nund .xmp-Sidecar) mitkommt oder nur RAW + Sidecar. Im Zielordner wird nie\netwas überschrieben.',
        'es': 'Mueve o copia las imágenes seleccionadas a una carpeta local. El diálogo\npregunta cuál de las dos y si se lleva el grupo completo (RAW, JPEG y el\nsidecar .xmp) o solo RAW + sidecar. Nunca se sobrescribe nada en la\ncarpeta de destino.',
        'fr': 'Déplace ou copie les images sélectionnées vers un dossier local. La boîte\nde dialogue demande laquelle des deux, et si l’on prend le groupe entier\n(RAW, JPEG et fichier .xmp) ou seulement RAW + fichier annexe. Rien n’est\njamais écrasé dans le dossier cible.',
        'it': 'Sposta o copia le immagini selezionate in una cartella locale. La finestra\nchiede quale delle due e se prendere l’intero gruppo (RAW, JPEG e sidecar\n.xmp) o soltanto RAW + sidecar. Nella cartella di destinazione non viene\nmai sovrascritto nulla.',
    },
    'Move or copy to folder': {
        'de': 'In Ordner verschieben oder kopieren',
        'es': 'Mover o copiar a una carpeta',
        'fr': 'Déplacer ou copier vers un dossier',
        'it': 'Sposta o copia in una cartella',
    },
    'Destination folder:': {
        'de': 'Zielordner:',
    ...
    'Move (the files leave this folder)': {
        'de': 'Verschieben (die Dateien verlassen diesen Ordner)',
        'es': 'Mover (los archivos salen de esta carpeta)',
        'fr': 'Déplacer (les fichiers quittent ce dossier)',
        'it': 'Sposta (i file lasciano questa cartella)',
    },
    'Copy (the files stay here as well)': {
        'de': 'Kopieren (die Dateien bleiben auch hier)',
        'es': 'Copiar (los archivos también se quedan aquí)',
        'fr': 'Copier (les fichiers restent également ici)',
        'it': 'Copia (i file restano anche qui)',
    },
    'Which files': {
        'de': 'Welche Dateien',
        'es': 'Qué archivos',
    ...
    'The whole group: RAW, JPEG and .xmp sidecar': {
        'de': 'Die ganze Gruppe: RAW, JPEG und .xmp-Sidecar',
        'es': 'El grupo completo: RAW, JPEG y sidecar .xmp',
        'fr': 'Le groupe entier : RAW, JPEG et fichier .xmp',
        'it': 'L’intero gruppo: RAW, JPEG e sidecar .xmp',
    },
    'RAW and .xmp sidecar only': {
        'de': 'Nur RAW und .xmp-Sidecar',
        'es': 'Solo RAW y sidecar .xmp',
        'fr': 'RAW et fichier .xmp seulement',
        'it': 'Solo RAW e sidecar .xmp',
    },
    'The JPEG of a pair stays behind. An entry without a RAW file still travels - there is no partner to leave.': {
        'de': 'Das JPEG eines Paares bleibt zurück. Ein Eintrag ohne RAW-Datei wandert trotzdem mit — da ist kein Partner, der zurückbleiben könnte.',
        'es': 'El JPEG de una pareja se queda atrás. Una entrada sin archivo RAW viaja igualmente: no hay pareja que dejar.',
        'fr': 'Le JPEG d’une paire reste sur place. Une entrée sans fichier RAW part quand même : il n’y a pas de partenaire à laisser.',
        'it': 'Il JPEG di una coppia resta indietro. Una voce senza file RAW parte comunque: non c’è nessun compagno da lasciare.',
    },
    'Pick a folder that exists.': {
        'de': 'Bitte einen Ordner wählen, den es gibt.',
        'es': 'Elige una carpeta que exista.',
        'fr': 'Choisissez un dossier qui existe.',
        'it': 'Scegli una cartella che esista.',
    },
    'subfolders': {
        'de': 'Unterordner',
        'es': 'subcarpetas',
    ...
    'open cards': {
        'de': 'Karten öffnen',
        'es': 'abrir tarjetas',
        'fr': 'ouvrir les cartes',
        'it': 'apri schede',
    },
    'Also read the subfolders of the folder that is opened. A full card holds\n100EOSR5, 101EOSR5 and so on, so a card needs this; a working folder\nusually does not.': {
        'de': 'Liest auch die Unterordner des geöffneten Ordners. Eine volle Karte enthält\n100EOSR5, 101EOSR5 und so weiter — eine Karte braucht das also; ein\nArbeitsordner in der Regel nicht.',
        'es': 'Lee también las subcarpetas de la carpeta abierta. Una tarjeta llena contiene\n100EOSR5, 101EOSR5 y así sucesivamente, de modo que una tarjeta lo necesita;\nuna carpeta de trabajo normalmente no.',
        'fr': 'Lit aussi les sous-dossiers du dossier ouvert. Une carte pleine contient\n100EOSR5, 101EOSR5 et ainsi de suite : une carte en a donc besoin, un dossier\nde travail généralement pas.',
        'it': 'Legge anche le sottocartelle della cartella aperta. Una scheda piena contiene\n100EOSR5, 101EOSR5 e così via, quindi una scheda ne ha bisogno; una cartella\ndi lavoro di solito no.',
    },
    'Opens a memory card by itself as soon as it is plugged in, subfolders and all.\nA volume counts as a card when it has a DCIM folder. Whatever was open\nbefore is replaced, so turn this off while working from a card.': {
        'de': 'Öffnet eine Speicherkarte von selbst, sobald sie eingesteckt wird, samt\nUnterordnern. Als Karte gilt ein Datenträger mit DCIM-Ordner. Was vorher\noffen war, wird ersetzt — beim Arbeiten von einer Karte also besser aus.',
        'es': 'Abre una tarjeta de memoria por sí sola en cuanto se conecta, con sus\nsubcarpetas. Un volumen cuenta como tarjeta si tiene una carpeta DCIM. Lo que\nestuviera abierto se sustituye, así que desactívalo al trabajar desde una tarjeta.',
        'fr': 'Ouvre une carte mémoire d’elle-même dès qu’elle est insérée, sous-dossiers\ncompris. Un volume compte comme carte s’il possède un dossier DCIM. Ce qui\nétait ouvert est remplacé : à désactiver quand vous travaillez depuis une carte.',
        'it': 'Apre una scheda di memoria da sé non appena viene inserita, sottocartelle\ncomprese. Un volume conta come scheda se ha una cartella DCIM. Quanto era\naperto viene sostituito: meglio disattivarlo mentre si lavora da una scheda.',
    },
    'Editing is off in fullscreen \u2014 F or Esc to leave': {
        'de': 'Im Vollbild wird nicht bearbeitet \u2014 F oder Esc zum Verlassen',
        'es': 'En pantalla completa no se edita \u2014 F o Esc para salir',
        'fr': 'Pas de retouche en plein \u00e9cran \u2014 F ou \u00c9chap pour sortir',
        'it': 'A schermo intero non si modifica \u2014 F o Esc per uscire',
    },
    'Fullscreen is open on another window.\nF or Esc there brings the picture back here.': {
        'de': 'Das Vollbild liegt in einem eigenen Fenster.\nF oder Esc dort holt das Bild hierher zurück.',
        'es': 'La pantalla completa está en otra ventana.\nF o Esc allí devuelve la imagen aquí.',
        'fr': 'Le plein écran occupe une autre fenêtre.\nF ou Échap là-bas ramène l’image ici.',
        'it': 'Lo schermo intero è in un’altra finestra.\nF o Esc lì riporta qui l’immagine.',
    },
    'Folder: {name}': {
        'de': 'Ordner: {name}',
        'es': 'Carpeta: {name}',
    ...
    'Time taken is the file time the camera wrote, not the EXIF field:\nreading EXIF would mean opening every RAW on the card. On a card\nstraight from the camera the two are the same.': {
        'de': 'Die Aufnahmezeit ist die Dateizeit, die die Kamera geschrieben hat, nicht\ndas EXIF-Feld: EXIF zu lesen hieße, jede RAW-Datei der Karte zu öffnen.\nAuf einer Karte direkt aus der Kamera ist beides dasselbe.',
        'es': 'La hora de la toma es la hora del archivo que escribió la cámara, no el campo\nEXIF: leer EXIF supondría abrir cada RAW de la tarjeta. En una tarjeta recién\nsacada de la cámara ambas coinciden.',
        'fr': 'L’heure de prise de vue est l’heure du fichier écrite par l’appareil, pas le\nchamp EXIF : lire l’EXIF obligerait à ouvrir chaque RAW de la carte. Sur une\ncarte sortie de l’appareil, les deux sont identiques.',
        'it': 'L’ora dello scatto è l’ora del file scritta dalla fotocamera, non il campo\nEXIF: leggere l’EXIF significherebbe aprire ogni RAW della scheda. Su una\nscheda appena tolta dalla fotocamera le due coincidono.',
    },
}
